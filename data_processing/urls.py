...
urlpatterns = [
    ...
    # Report - entity link actions
    path(
        "report/<int:report_id>/entity/<int:entity_id>/unlink/",
        views.unlink_entity_from_report,
        name="unlink_entity_from_report",
    ),
    path(
        "report/<int:report_id>/entity/<int:entity_id>/relink/",
        views.relink_entity_to_report,
        name="relink_entity_to_report",
    ),
    path(
        "report/<int:report_id>/entity/add/",
        views.add_entity_to_report,
        name="add_entity_to_report",
    ),
